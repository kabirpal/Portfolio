			...
			<main className="bg-white px-10 md:px-20 lg:px-30 dark:bg-gray-600 dark:text-white">
				<section className="min-h-screen">
					...
					<div className="flex text-5xl justify-center text-gray-500">
						<a href="https://www.linkedin.com/in/kabirpal/"><AiFillLinkedin className="hover:text-gray-800"></AiFillLinkedin></a>
						<AiFillMail className="hover:text-gray-800 hover:cursor-pointer" onClick={openGmailWithCC}></AiFillMail>
						<a href="https://github.com/kabirpal/"><AiFillGithub className="hover:text-gray-800"></AiFillGithub></a>
					</div>
